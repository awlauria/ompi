...
static inline void mca_common_monitoring_coll_cache(mca_monitoring_coll_data_t *data)
{
    if (-1 == data->world_rank) {
        ...
        mca_common_monitoring_get_world_rank(ompi_comm_rank(data->p_comm),
                                             data->p_comm->c_remote_group, &data->world_rank);
    }
...
void mca_common_monitoring_coll_flush(FILE *pf, mca_monitoring_coll_data_t *data)
{
    ...
    fprintf(pf,
            ...
            data->comm_name ? data->comm_name : data->p_comm ? data->p_comm->c_name : "(no-name)",
            data->procs, data->world_rank, data->o2a_size, data->o2a_count, data->world_rank,
            data->a2o_size, data->a2o_count, data->world_rank, data->a2a_size, data->a2a_count);
}
...
int mca_common_monitoring_coll_messages_notify(mca_base_pvar_t *pvar, mca_base_pvar_event_t event,
...
int mca_common_monitoring_coll_get_o2a_count(const struct mca_base_pvar_t *pvar, void *value,
                                             void *obj_handle)
{
...
int mca_common_monitoring_coll_get_o2a_size(const struct mca_base_pvar_t *pvar, void *value,
                                            void *obj_handle)
{
    ompi_communicator_t *comm = (ompi_communicator_t *) obj_handle;
    size_t *value_size = (size_t *) value;
...
int mca_common_monitoring_coll_get_a2o_count(const struct mca_base_pvar_t *pvar, void *value,
                                             void *obj_handle)
{
    ompi_communicator_t *comm = (ompi_communicator_t *) obj_handle;
    size_t *value_size = (size_t *) value;
...
int mca_common_monitoring_coll_get_a2o_size(const struct mca_base_pvar_t *pvar, void *value,
                                            void *obj_handle)
{
    ompi_communicator_t *comm = (ompi_communicator_t *) obj_handle;
    size_t *value_size = (size_t *) value;
...
int mca_common_monitoring_coll_get_a2a_count(const struct mca_base_pvar_t *pvar, void *value,
                                             void *obj_handle)
{
    ompi_communicator_t *comm = (ompi_communicator_t *) obj_handle;
    size_t *value_size = (size_t *) value;
...
int mca_common_monitoring_coll_get_a2a_size(const struct mca_base_pvar_t *pvar, void *value,
                                            void *obj_handle)
{
    ompi_communicator_t *comm = (ompi_communicator_t *) obj_handle;
    size_t *value_size = (size_t *) value;
...
OBJ_CLASS_INSTANCE(mca_monitoring_coll_data_t, opal_object_t, mca_monitoring_coll_construct,
