...
int main(int argc, char *argv[])
{
    ...
    if (0 == rank) {
        ...
        opal_output(
            0, "This test ensures that the aggregation functionality of the opal_show_help\nsystem "
               "is working properly.  It outputs a bogus warning about prte_init(),\nand contains "
    ...
    opal_show_help("help-opal-runtime.txt", "opal_init:startup:internal-failure", true, "Nothing",
                   "OPAL_EVERYTHING_IS_PEACHY", "42");
    sleep(rank * 3);

    opal_show_help("help-opal-runtime.txt", "opal_init:startup:internal-failure", true,
                   "Duplicate opal_show_help detection", "OPAL_SHOW_HELP_DUPLICATE_FAILED",
                   "99999");
